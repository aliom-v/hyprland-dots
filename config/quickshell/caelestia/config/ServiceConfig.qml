...
JsonObject {
    readonly property real minimumAdjustmentStep: 0.05
    ...
    onAudioIncrementChanged: {
        if (audioIncrement < minimumAdjustmentStep)
            audioIncrement = minimumAdjustmentStep;
    }

    onBrightnessIncrementChanged: {
        if (brightnessIncrement < minimumAdjustmentStep)
            brightnessIncrement = minimumAdjustmentStep;
    }
}
