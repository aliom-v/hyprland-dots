...
Item {
    ...
    readonly property var zhLocale: Qt.locale("zh_CN")
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            Column {
                ...
                StyledText {
                    text: new Date().toLocaleDateString(root.zhLocale, "dddd, MMMM d")
                ...
                StyledRect {
                    ...
                    ColumnLayout {
                        ...
                        StyledText {
                            ...
                            text: forecastItem.index === 0 ? qsTr("今天") : new Date(forecastItem.modelData.date).toLocaleDateString(root.zhLocale, "ddd")
                            font.pointSize: Appearance.font.size.normal
                            font.weight: 600
                            color: Colours.palette.m3primary
                        }
                        ...
                        StyledText {
                            ...
                            Layout.alignment: Qt.AlignHCenter
                            text: new Date(forecastItem.modelData.date).toLocaleDateString(root.zhLocale, "MMM d")
                            font.pointSize: Appearance.font.size.small
                            opacity: 0.7
                            color: Colours.palette.m3onSurfaceVariant
                        }
