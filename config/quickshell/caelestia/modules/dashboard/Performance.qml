        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                HeroCard {
                    ...
                    icon: "memory"
                    title: SystemUsage.cpuName ? qsTr("处理器 - %1").arg(SystemUsage.cpuName) : qsTr("处理器")
                ...
                HeroCard {
                    ...
                    title: SystemUsage.gpuName ? qsTr("图形处理器 - %1").arg(SystemUsage.gpuName) : qsTr("图形处理器")
