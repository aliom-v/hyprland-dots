...
QtObject {
    ...
    readonly property list<QtObject> panes: [
        QtObject {
            ...
            readonly property string displayLabel: "网络"
        ...
        QtObject {
            ...
            readonly property string displayLabel: "蓝牙"
        ...
        QtObject {
            ...
            readonly property string displayLabel: "音频"
        ...
        QtObject {
            ...
            readonly property string displayLabel: "外观"
        ...
        QtObject {
            ...
            readonly property string displayLabel: "任务栏"
        ...
        QtObject {
            ...
            readonly property string displayLabel: "启动器"
        ...
        QtObject {
            ...
            readonly property string displayLabel: "仪表盘"
    ...
    function getDisplayLabel(label: string): string {
        const pane = getByLabel(label);
        return pane ? pane.displayLabel : label;
    }
}
