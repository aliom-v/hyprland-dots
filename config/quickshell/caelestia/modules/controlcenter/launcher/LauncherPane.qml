...
Item {
    ...
    onSelectedAppChanged: {
        ...
        if (root.selectedApp)
            root.session.launcher.showSettings = false;
        updateToggleState();
    }
    ...
    SplitPaneLayout {
        ...
        leftContent: Component {
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    ToggleButton {
                        toggled: root.session.launcher.showSettings || !root.session.launcher.active
                        icon: "settings"
                        accent: "Primary"
                        iconSize: Appearance.font.size.normal
                        horizontalPadding: Appearance.padding.normal
                        verticalPadding: Appearance.padding.smaller
                        tooltip: qsTr("打开启动器设置")

                        onClicked: {
                            root.session.launcher.showSettings = true;
                        }
                    }
                }
                    ...
                    sourceComponent: StyledListView {
                        ...
                        implicitHeight: 40
                            ...
                            RowLayout {
                                ...
                                StyledText {
                                    Layout.fillWidth: true
                                    text: modelData.name || modelData.entry?.name || qsTr("未知应用")
                                    font.pointSize: Appearance.font.size.normal
                                }
        ...
        rightContent: Component {
            Item {
                ...
                property bool displaySettings: root.session.launcher.showSettings || !pane
                ...
                function getComponentForPane() {
                    return displaySettings ? settings : appDetails;
                }

                Component.onCompleted: {
                    displayedApp = pane;
                    paneId = displaySettings ? "settings" : (pane ? (pane.id || pane.entry?.id || "") : "");
