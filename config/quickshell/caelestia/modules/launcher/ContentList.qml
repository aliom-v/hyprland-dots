...
Item {
    ...
    Row {
        ...
        Column {
            ...
            StyledText {
                text: root.state === "wallpapers" ? qsTr("未找到壁纸") : qsTr("没有结果")
                color: Colours.palette.m3onSurfaceVariant
            ...
            StyledText {
                text: root.state === "wallpapers" && Wallpapers.list.length === 0 ? qsTr("试着把一些壁纸放到 %1").arg(Paths.shortenHome(Paths.wallsdir)) : qsTr("试试搜索别的内容")
                color: Colours.palette.m3onSurfaceVariant
