...
StyledRect {
    ...
    RowLayout {
        ...
        ColumnLayout {
            ...
            StyledText {
                Layout.fillWidth: true
                text: IdleInhibitor.enabled ? qsTr("正在阻止休眠") : qsTr("正常电源管理")
    ...
    Loader {
        ...
        sourceComponent: StyledRect {
            ...
            StyledText {
                ...
                anchors.centerIn: parent
                text: qsTr("已启用：%1").arg(Qt.formatTime(IdleInhibitor.enabledSince, Config.services.useTwelveHourClock ? "hh:mm a" : "hh:mm"))
