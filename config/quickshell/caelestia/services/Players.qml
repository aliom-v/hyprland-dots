    ...
    Connections {
        ...
        function onPostTrackChanged() {
            ...
            if (active.trackArtist != "" && active.trackTitle != "") {
                Toaster.toast(qsTr("正在播放"), qsTr("%1 - %2").arg(active.trackArtist).arg(active.trackTitle), "music_note");
            }
        }
    }
